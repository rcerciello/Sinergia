...
public class AddEmployeeActivity extends AppCompatActivity implements AddEmployeeContract.View, CustomSaveButton.CustomSaveButtonInterface {
    ...
    private AddEmployeeContract.Presenter mPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTextChangedListener(nome, FieldRequired.NOME );
        setTextChangedListener(cognome, FieldRequired.COGNOME );
        setTextChangedListener(landline, FieldRequired.LANDLINE );
        setTextChangedListener(email, FieldRequired.EMAIL );


        saveButton.getButtonReference().setOnClickListener(v -> {
            saveButton.changeState();
//            ClientModel  client = new ClientModel(null, nome.getText(), cognome.getText(), indirizzo.getText(), landline.getText().toLowerCase(), mobilePhone.getText(), email.toString());
//            mPresenter.addClient(client);
        });
    }

    private void setTextChangedListener(final CustomEditText editText,final FieldRequired type) {
        if (editText != null) {
    ...
    @Override
    public void setPresenter(AddEmployeeContract.Presenter presenter) {
...
//        if (!thereIsError) {
//            ClientModel model = new ClientModel(nome.getText(), cognome.getText(), indirizzo.getText(), landline.getText(), mobilePhone.getText(), "", email.getText());
